...
This document describes how to copy and customise the pbb theme so that
...
From your Moodle theme directory right click on pbb and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of pbb.
...
underscores. For the purpose of this tutorial we will call the theme 'pbbtheme'.

On opening 'pbbtheme'  you will find several files and sub-directories which have
files within them.
...
/javascript/
    This directory contains all the JS files for this theme.
/fonts/
    This directory contains  the fonts used in this theme.
/pix/
...
where the old theme name occurs, in this case pbb. So using the above list as
a guide, search through and change all the instances of the theme name
'pbb' to 'pbbtheme'. This includes the filename of the lang/en/theme_pbb.php.
You need to change this to 'theme_pbbtheme.php'.
...
and then click on (pbbtheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the pbb theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > pbb

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/Themes
